<!-- Quick Actions Panel -->
<div class="w-full lg:w-1/3 bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg mb-8 lg:mb-0">
    ...
    <div class="p-6 text-gray-900 dark:text-gray-100 border-t border-gray-200 dark:border-gray-700">
        <h4 class="text-lg font-semibold mb-3">Auto's</h4>
        ...
        <a href="{{ route('autos.create') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 4v16m8-8H4" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 114 0z" />
            </svg>
            Nieuwe auto
        </a>
    </div>
