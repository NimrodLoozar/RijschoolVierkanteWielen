        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <form method="POST" action="{{ route('autos.store') }}">
                    ...
                    <div class="mb-4">
                        <label for="license_plate" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Kenteken (optioneel)</label>
                        <input type="text" name="license_plate" id="license_plate"
                            class="bg-gray-200 text-gray-900 p-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            placeholder="Laat leeg voor automatisch kenteken">
                        @error('license_plate')
