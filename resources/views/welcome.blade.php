        ...
        <main class="">
                        ...
                        <div class="mt-6 flow-root">
                            <div class="-my-6 divide-y divide-gray-500/10">
                                <div class="space-y-2 py-6">
                                    ...
                                    <a href="#instructors"
                                        class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-700 hover:bg-gray-900">Instructeurs</a>
                                    <a href="#FAQ"
            ...
            <div class="relative isolate overflow-hidden py-24 sm:py-32">
                <div class="absolute inset-0 -z-10 w-full h-full overflow-hidden">
                    <img src="{{ asset('img/highway.webp') }}" alt=""
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="lg:pr-4">
                            <div class="lg:max-w-lg">
                                ...
                                <p class="mt-6 text-xl/8 text-gray-700">Bij Rijschool Vierkante Wielen geloven we dat
                                    iedereen
                                    de kans verdient om veilig en zelfverzekerd de weg op te gaan. Met onze ervaren
                                    instructeurs
                                    en persoonlijke aanpak zorgen we ervoor dat jij je rijbewijs haalt op een manier die
                                    bij
                                    jou
                                    past.</p>
                            </div>
                    ...
                    <div
                        ...
                        <img class="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]"
                            src="{{ asset('img/driving_lesson.webp') }}"
                    ...
                    <div
                        ...
                        <div class="lg:pr-4">
                            <div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
                                <p>Onze rijschool biedt een breed scala aan diensten, van reguliere rijlessen tot
                                    intensieve
                                    cursussen en opfrislessen. Of je nu een beginnende bestuurder bent of je
                                    vaardigheden
                                    wilt
                                ...
                                <ul role="list" class="mt-8 space-y-8 text-gray-600">
                                    <li class="flex gap-x-3">
                                        <span><strong class="font-semibold text-gray-900">Persoonlijke
                                                begeleiding.</strong>
                                            Onze instructeurs passen zich aan jouw leertempo aan, zodat je altijd
                                            comfortabel en
                                    ...
                                    <li class="flex gap-x-3">
                                        ...
                                        <span><strong class="font-semibold text-gray-900">Moderne voertuigen.</strong>
                                            Onze
                                            auto's zijn uitgerust met de nieuwste technologieën om jouw leerervaring
                                            veilig
                                            en
                                    ...
                                    <li class="flex gap-x-3">
                                        ...
                                        <span><strong class="font-semibold text-gray-900">Flexibele lestijden.</strong>
                                            Wij
                                            begrijpen dat iedereen een druk schema heeft. Daarom bieden we lessen aan op
                                            tijden
                                            die jou uitkomen.</span>
                                    </li>
                                </ul>
                                <p class="mt-8">Bij Rijschool Vierkante Wielen draait alles om jou. We streven ernaar
                                    om
                                    van
                                    elke les een leerzame en plezierige ervaring te maken. Samen zorgen we ervoor dat
                                    jij
                                    met
                                ...
                                <p class="mt-6">Met jarenlange ervaring en een bewezen succesratio zijn wij de
                                    rijschool
                                    waar
                                    je op kunt vertrouwen. Onze leerlingen waarderen onze geduldige aanpak en ons
                                    vermogen
                                    om
                        ...
                        <div class="relative lg:row-span-2">
                            ...
                            <div
                                ...
                                <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                    ...
                                    <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Onze
                                        instructeurs
                                        passen zich aan jouw leertempo aan, zodat je altijd comfortabel en zelfverzekerd
                                        achter
                                        het stuur zit.</p>
                                </div>
                                <div
                            ...
                            <div
                                ...
                                <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                                    <p
                                        ...
                                        Moderne
                                        voertuigen</p>
                                    <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Onze auto's
                                        zijn
                                        uitgerust met de nieuwste technologieën om jouw leerervaring veilig en efficiënt
                                        te
                                        maken.</p>
                                </div>
                                <div
                        ...
                        <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                            ...
                            <div
                                ...
                                <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                                    ...
                                    <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Wij bieden
                                        lessen
                                        aan
                                        op tijden die jou uitkomen, zodat je je rijlessen kunt plannen rond jouw drukke
                                        schema.
                                    </p>
                                </div>
                                <div class="@container flex flex-1 items-center justify-center max-lg:py-6 lg:pb-2">
                                    <img class="h-[min(152px,40cqw)] object-cover bg-transparant"
                        ...
                        <div class="relative lg:row-span-2">
                            ...
                            <div
                                ...
                                <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                    ...
                                    <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Voor degenen
                                        die
                                        snel
                                        hun rijbewijs willen halen, bieden we intensieve cursussen aan die zijn
                                        afgestemd op
                                        jouw behoeften.</p>
                                </div>
                                <div class="relative min-h-[30rem] w-full grow">
                                    <div
                                        ...
                                        <img class="size-full object-cover"
                                            src="{{ asset('img/intensive_courses.webp') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                        <div class="max-w-xl lg:max-w-lg">
                            <h2 class="text-4xl font-semibold tracking-tight text-white">Abonneer je op onze
                                nieuwsbrief
                            </h2>
                        ...
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                            <div class="flex flex-col items-start">
                                ...
                                <dd class="mt-2 text-base/7 text-gray-400">Non laboris consequat cupidatat laborum
                                    magna.
                ...
                <div class="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-3">
                    <div class="max-w-xl">
                        <h2 class="text-3xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-4xl">Ontmoet
                            ons
                            leiderschapsteam</h2>
                        <p class="mt-6 text-lg/8 text-gray-600">We zijn een dynamische groep individuen die
                            gepassioneerd
                            zijn
                            over wat we doen en toegewijd zijn aan het leveren van de beste resultaten voor onze
                            klanten.
                        </p>
                    </div>
                        ...
                        <li>
                            <div class="flex items-center gap-x-6">
                                <img class="size-16 rounded-full"
                                    ...
                                    alt="">
                                <div>
                                    <h3 class="text-base/7 font-semibold tracking-tight text-gray-900">Leslie Alexander
                                    </h3>
                ...
                <div class="space-y-6 max-w-4xl mx-auto">
                    ...
                    <div class="border-b pb-4">
                        ...
                        <div class="faq-answer text-gray-600 mt-2 text-sm sm:text-base">
                            <p class="pt-2">De kosten voor een rijles bedragen €50 per uur. We bieden ook pakketten
                                aan
                                met
                                korting.</p>
                        </div>
                    ...
                    <div class="border-b pb-4">
                        ...
                        <div class="faq-answer text-gray-600 mt-2 text-sm sm:text-base">
                            <p class="pt-2">Je kunt je inschrijven via onze website of door contact op te nemen met
                                onze
                                klantenservice.</p>
                        </div>
                    </div>
                    ...
                    <div class="border-b pb-4">
                        ...
                        <div class="faq-answer text-gray-600 mt-2 text-sm sm:text-base">
                            <p class="pt-2">Gemiddeld hebben leerlingen tussen de 30 en 40 lessen nodig, afhankelijk
                                van
                                hun
                    ...
                    <div class="border-b pb-4">
                        ...
                        <div class="faq-answer text-gray-600 mt-2 text-sm sm:text-base">
                            <p class="pt-2">Ja, we bieden een proefles aan voor €25. Dit bedrag wordt verrekend als
                                je
                    ...
                    <div class="border-b pb-4">
                        ...
                        <div class="faq-answer text-gray-600 mt-2 text-sm sm:text-base">
                            <p class="pt-2">Ja, je kunt je lessen tot 24 uur van tevoren annuleren of verplaatsen
                                zonder
                                extra kosten.</p>
                        </div>
                    </div>
